---
name: portmarshal
description: Start, inspect, diagnose and safely stop local development servers with PortMarshal. Use for dev-server startup, port conflicts, service ownership or detached-service investigation; not for production infrastructure.
---
